...
//////////////////////////////////////////////////////////////////////////
// ABehaviourTreeAICharacter

ABehaviourTreeAICharacter::ABehaviourTreeAICharacter()
{
...
void ABehaviourTreeAICharacter::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();
...
void ABehaviourTreeAICharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &ABehaviourTreeAICharacter::Move);
...
void ABehaviourTreeAICharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void ABehaviourTreeAICharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
